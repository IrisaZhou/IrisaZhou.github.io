...
_styles: >
  ...
  .guide-outline .list-group-item { border-radius: 0.5rem !important; margin-bottom: 0.5rem; border: 1px solid #dee2e6; }
  .guide-outline .list-group-item:hover { background-color: #f8f9fa; }
